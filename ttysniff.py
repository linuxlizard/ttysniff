...
# ttysniff.py read/write serial port in Python (single file and easier to use
# than pyserial)
#
# Copyright (c) 2014-2020 David Poole <davep@mbuf.com>
...
def print_tty_attr(tty_attr):
    ...
    charsize = cflag & termios.CSIZE
    print(
        "termios.CSIZE=%#x charsize=%#x (%s)"
        % (termios.CSIZE, charsize, get_char_size(cflag))
    )
